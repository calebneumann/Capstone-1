 ...
 */
export type WebhookTrigger = 'UNSPECIFIED_TRIGGER' | 'MESSAGE_DELIVERY' | 'MESSAGE_SUBMIT' | 'MESSAGE_INBOUND' | 'EVENT_DELIVERY' | 'EVENT_INBOUND' | 'SMART_CONVERSATIONS' | 'MESSAGE_INBOUND_SMART_CONVERSATION_REDACTION' | 'CONVERSATION_START' | 'CONVERSATION_STOP' | 'CONVERSATION_DELETE' | 'CONTACT_CREATE' | 'CONTACT_DELETE' | 'CONTACT_MERGE' | 'CONTACT_UPDATE' | 'CONTACT_IDENTITIES_DUPLICATION' | 'UNSUPPORTED' | 'OPT_IN' | 'OPT_OUT' | 'CHANNEL_EVENT' | 'CAPABILITY' | 'RECORD_NOTIFICATION';
