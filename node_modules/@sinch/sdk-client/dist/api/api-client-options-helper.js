...
const buildFlexibleOAuth2OrApiTokenApiClientOptions = (params, region, apiName) => {
    ...
    if (params.forceOAuth2ForSmsApi
        || (!params.forceServicePlanIdUsageForSmsApi && (region === domain_1.SmsRegion.UNITED_STATES || region === domain_1.SmsRegion.EUROPE))) {
